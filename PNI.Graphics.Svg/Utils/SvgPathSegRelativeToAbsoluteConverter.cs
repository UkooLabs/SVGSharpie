...
namespace PNI.Graphics.Svg.Utils
{
    /// <inheritdoc />
    /// <summary>
    /// Transforms all relative path segment commands to their absolute command equivalents.
    /// For example a <see cref="T:PNI.Graphics.Svg.SvgPathSegMovetoRel" /> will be transformed into a 
    /// <see cref="M:PNI.Graphics.Svg.Utils.SvgPathSegRelativeToAbsoluteConverter.VisitMovetoAbs(PNI.Graphics.Svg.SvgPathSegMovetoAbs)" />.
    /// </summary>
